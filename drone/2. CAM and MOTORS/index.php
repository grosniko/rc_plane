...
<?php
   ...
   //below line gives access to i2c bus
   //exec("sudo chmod 666 /dev/i2c-1");
      ...
      <div class="container-fluid text-center">
         <div class="panel-group" id="accordion" <?php getdisplayStyle('settings', $userLevel); ?> >
                  ...
                  <div class="panel-body">
                     <table class="settingsTable">
                        ...
                        <tr>
                           ...
                           <td>
                              Text: <?php makeInput('annotation', 20); ?><input type="button" value="OK" onclick="send_cmd('an ' + encodeURI(document.getElementById('annotation').value))"><input type="button" value="Default" id="annotation_default" onclick="document.getElementById('annotation').value = '%Y.%M.%D_%h:%m:%s'; send_cmd('an ' + encodeURI(document.getElementById('annotation').value))"><br>
            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                  <h2 class="panel-title">
                     <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Help</a>
                  </h2>
               </div>
